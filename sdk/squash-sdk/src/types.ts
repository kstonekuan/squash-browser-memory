...
export type ContextStatus = 'success' | 'not_initialized' | 'not_installed' | 'permission_denied' | 'error';
...
export interface ExtensionAPI {
  ...
  getContext: (options?: ContextOptions) => Promise<{ success: boolean; data?: any; error?: string }>;
