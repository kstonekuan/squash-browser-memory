...
import type { Context, ContextResult } from "./types";

const mockPatterns = [
	{
		name: "Code Development Workflow",
		description:
			"Frequently switches between IDE, documentation, and Stack Overflow",
		frequency: 0.85,
	...
	},
	{
		...
		description:
			"Regular use of GitHub issues, Jira, and team communication tools",
		frequency: 0.65,
...
export function generateMockContext(options?: {
